...
public class ModelReindeer<T extends AbstractHorseEntity> extends HorseModel<T> {
    ...
    public ModelReindeer(float scale) {
        super(scale);
        ...
        head.setTextureOffset(52, 0).addBox(2.0F, -14.0F, 3.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(52, 0).addBox(-3.0F, -14.0F, 3.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(56, 0).addBox(1.0F, -15.0F, 4.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(56, 0).addBox(-2.0F, -15.0F, 4.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(56, 0).addBox(3.0F, -16.0F, 4.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(56, 0).addBox(-4.0F, -16.0F, 4.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(60, 0).addBox(4.0F, -18.0F, 5.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(60, 0).addBox(-5.0F, -18.0F, 5.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(60, 0).addBox(5.0F, -19.0F, 6.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(60, 0).addBox(-4.0F, -20.0F, 6.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(60, 0).addBox(3.0F, -20.0F, 6.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(60, 0).addBox(-6.0F, -19.0F, 6.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        ModelRenderer modelrenderer = new ModelRenderer(this, 0, 13);
        modelrenderer.addBox(-3.0F, -11.0F, -2.0F, 6.0F, 5.0F, 7.0F, scale);
        ModelRenderer modelrenderer1 = new ModelRenderer(this, 56, 36);
        modelrenderer1.addBox(-1.0F, -11.0F, 5.01F, 2.0F, 16.0F, 2.0F, scale);
        ModelRenderer modelrenderer2 = new ModelRenderer(this, 0, 25);
        modelrenderer2.addBox(-2.0F, -11.0F, -7.0F, 4.0F, 5.0F, 5.0F, scale);
        ...
        this.field_228262_f_.addBox(-3.0F, -1.01F, -1.0F, 4.0F, 11.0F, 4.0F, scale);
        this.field_228262_f_.setRotationPoint(4.0F, 14.0F, 7.0F);
        this.field_228263_g_ = new ModelRenderer(this, 48, 21);
        this.field_228263_g_.addBox(-1.0F, -1.01F, -1.0F, 4.0F, 11.0F, 4.0F, scale);
        ...
        this.field_228264_h_.addBox(-3.0F, -1.01F, -1.9F, 4.0F, 11.0F, 4.0F, scale);
        this.field_228264_h_.setRotationPoint(4.0F, 6.0F, -12.0F);
        this.field_228265_i_ = new ModelRenderer(this, 48, 21);
        this.field_228265_i_.addBox(-1.0F, -1.01F, -1.9F, 4.0F, 11.0F, 4.0F, scale);
        ...
        this.field_228266_j_.addBox(-3.0F, -1.01F, -1.0F, 4.0F, 11.0F, 4.0F, scale, scale + 5.5F, scale);
        this.field_228266_j_.setRotationPoint(4.0F, 14.0F, 7.0F);
        this.field_228267_k_ = new ModelRenderer(this, 48, 21);
        this.field_228267_k_.addBox(-1.0F, -1.01F, -1.0F, 4.0F, 11.0F, 4.0F, scale, scale + 5.5F, scale);
        ...
        this.field_228268_l_.addBox(-3.0F, -1.01F, -1.9F, 4.0F, 11.0F, 4.0F, scale, scale + 5.5F, scale);
        this.field_228268_l_.setRotationPoint(4.0F, 6.0F, -12.0F);
        this.field_228269_m_ = new ModelRenderer(this, 48, 21);
        this.field_228269_m_.addBox(-1.0F, -1.01F, -1.9F, 4.0F, 11.0F, 4.0F, scale, scale + 5.5F, scale);
        this.field_228269_m_.setRotationPoint(-4.0F, 6.0F, -12.0F);
        this.field_217133_j = new ModelRenderer(this, 42, 36);
        this.field_217133_j.addBox(-1.5F, 0.0F, 0.0F, 3.0F, 14.0F, 4.0F, scale);
        ...
        modelrenderer7.addBox(-3.1F, -6.0F, -8.0F, 0.0F, 3.0F, 16.0F, scale);
    ...
    protected void func_199047_a(ModelRenderer p_199047_1_) {
        ...
        modelrenderer.addBox(-3.5F, -10.0F, 4.99F, 2.0F, 1.0F, 3.0F, -0.001F);
        ModelRenderer modelrenderer1 = new ModelRenderer(this, 19, 16);
        modelrenderer1.addBox(1.5F, -10.0F, 4.99F, 2.0F, 1.0F, 3.0F, -0.001F);
